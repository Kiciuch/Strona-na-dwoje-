              ...
              <div class="card-header card-header-primary">
                ...
                <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                      ...
                      <label class="btn btn-sm btn-primary btn-simple" id="2">
                        <input type="radio" name="options" autocomplete="off"> RTV
                      </label>
                    </div>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="page1">
                    <thead class=" text-primary">
                      <tr><th>Zdjęcie</th><th>Nazwa</th><th>Tytuł</th><th>
	<a class=" btn btn-primary" href="addproduct.php">Dodaj</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        <a class=' btn btn-success' href='clothes_list.php?product_id=$product_id&action=delete'>USUŃ</a>
                        </td></tr>";
                        }
