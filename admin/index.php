      ...
      <div class="content">
		...
		<a>
                ...
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Imię</th><th>Nazwisko</th><th>Email</th><th>Hasło</th><th>Kontakt</th><th>Adres</th><th>MIasto</th>
                    </tr></thead>
                    <tbody>
                      <?php 
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Kategorie</th><th>Ilość</th>
                    </tr></thead>
                    <tbody>
                      <?php 
          ...
          <div class="col-md-6">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">Lista Firm</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Firma</th><th>Ilość</th>
                    </tr></thead>
                    <tbody>
                      <?php 
