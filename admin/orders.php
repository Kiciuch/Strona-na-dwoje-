          ...
          <div class="col-md-14">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">Zamówienia <?php echo $page;?> </h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                      <tr><th>Nazwa użytkownika</th><th>Produkt</th><th>kontakt | Email</th><th>Adres</th><th>Szczegóły</th><th>Przesyłka</th><th>Ilość</th>
                    </tr></thead>
                    <tbody>
                      <?php 
                        ...
                        <td>
                        <a class=' btn btn-danger' href='orders.php?order_id=$order_id&action=delete'>USUŃ</a>
                        </td></tr>";
                        }
                        ?>
                    </tbody>
