	...
	<div class="container-fluid">
		...
		echo'
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						<h3>Płatność</h3>
						<label for="fname">Przyjmujemy karty</label>
						...
						<label for="cname">Właściciel karty</label>
						...
						<label for="expdate">Data wygaśnięcia</label>
					...
					<label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required> Dane do rachunku takie same jak dostawy
					</label>';
					$i=1;
					$total=0;
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="submit" id="submit" value="Kontynuuj" class="checkout-btn">
				</form>
				</div>
			</div>
			';
		...
		?>
			...
			<div class="col-25">
				...
				<h3>Razem<span class='price' style='color:black'><b>$$total</b></span></h3>";
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Zapisz się na<strong> NOWOŚĆI</strong></p>
							<form >
								<input class="input" type="email" placeholder="Wpisz swój email">
								<button class="newsletter-btn"><i class="fa fa-envelope"></i> Zapisz się</button>
							</form>
